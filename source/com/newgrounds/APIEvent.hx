...
extern class APIEvent extends flash.events.Event {
	...
	static var BRIDGE_EVENT_RECEIVED(default,never) : String;
	...
	static var ERROR_SIGN_IN_FAILED(default,never) : String;
	...
	static var FILE_DELETED(default,never) : String;
	...
	static var USER_SIGNED_IN(default,never) : String;
