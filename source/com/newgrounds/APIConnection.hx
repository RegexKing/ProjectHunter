...
extern class APIConnection {
	...
	function loadInBrowser(p1 : String, p2 : Bool = true, ?p3 : flash.utils.Object) : Void;
	function reset() : Void;
	function sendCommand(p1 : APICommand) : Void;
	function sendSimpleCommand(p1 : String, p2 : flash.utils.Function, ?p3 : flash.utils.Object, ?p4 : flash.utils.Object) : Void;
