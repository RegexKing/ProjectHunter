...
{
		HX_STACK_FRAME("Main","init",0xea732345,"Main.init","Main.hx",46,0x087e5c05)
		HX_STACK_THIS(this)
		HX_STACK_ARG(E,"E")
		HX_STACK_LINE(47)
		...
		HX_STACK_LINE(52)
		::openfl::_legacy::display::Loader playerio_loader = ::openfl::_legacy::display::Loader_obj::__new();		HX_STACK_VAR(playerio_loader,"playerio_loader");
		HX_STACK_LINE(53)
		playerio_loader->contentLoaderInfo->addEventListener(::openfl::_legacy::events::Event_obj::COMPLETE,this->onComplete_dyn(),null(),null(),null());
		HX_STACK_LINE(54)
		::LibraryPlayerIO _g = ::LibraryPlayerIO_obj::__new(null());		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(54)
		playerio_loader->loadBytes(_g,null());
	}
return null();
}
...
Void Main_obj::onComplete( ::openfl::_legacy::events::Event ev){
{
		HX_STACK_FRAME("Main","onComplete",0xf50652ed,"Main.onComplete","Main.hx",58,0x087e5c05)
		HX_STACK_THIS(this)
		HX_STACK_ARG(ev,"ev")
		HX_STACK_LINE(59)
		this->setupGame();
		HX_STACK_LINE(60)
		::haxe::Log_obj::trace(HX_CSTRING("done"),hx::SourceInfo(HX_CSTRING("Main.hx"),60,HX_CSTRING("Main"),HX_CSTRING("onComplete")));
	}
return null();
}


HX_DEFINE_DYNAMIC_FUNC1(Main_obj,onComplete,(void))

Void Main_obj::setupGame( ){
{
		HX_STACK_FRAME("Main","setupGame",0x7f7688ba,"Main.setupGame","Main.hx",64,0x087e5c05)
		HX_STACK_THIS(this)
		HX_STACK_LINE(65)
